...
仓库名称取OSHW，顾名思义，本仓库存储 Lexsion 的开源硬件项目。因为贫穷导致无力购买高性能的新电脑以运行卡顿的Altium Designer ，外加近段时间其名声不好，笔者打算换一款EDA工具。听闻KiCad是一款开源的设计工具，于是笔者就选择了它。考虑开源硬件的特殊性，使用商业的EDA工具设计可能并不是一个好的选择，因此本项目下所有设计，都是使用KiCad完成的。
